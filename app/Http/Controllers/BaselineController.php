...
//First Baseline
   ...
   // orints trip end if there is on the road followed by false on column on the road
    public function tripEnd()
    {
       ...
       // dd('testing');
         ...
         $truckData = DB::connection('mysql')->table('baselinev2')->whereBetween('Date', ['2024-05-01' , '2024-05-02'])->groupBy('Truck')->orderBy('id')->get();  
   ...
   ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     public function SoapFleetboard()
    {
        ...
        $truckData = DB::connection('mysql')->table('baselinetest')->where('Truck','=','SL152 JST074MP')->groupBy('Truck')->orderBy('id')->get();
